...
- **One camera:** `front_window` @ 192.168.1.33 (Reolink E1 Pro, 2.4 GHz WiFi, no ethernet port; 4 zones — entrance, sidewalk, active_street, northside; tracks person + car). The `backyard` RLC-510WA (`.248`) was removed from this config 2026-09-08 — it moves to New Paltz with the M1 and its camera block now lives in `frigate/config.np.yml`. It had been `enabled: false` since 2026-08-05, so Brooklyn has been a one-camera site in practice since then.
